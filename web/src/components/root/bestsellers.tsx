...
export function Bestsellers({ products = [] }: BestsellersProps) {
  ...
  return (
    <section
      className="py-16 md:py-24 bg-linear-to-b from-white via-[#F8FCFF] to-white relative overflow-hidden"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* Background soft glows */}
      <div className="absolute top-1/2 -right-32 w-80 h-80 bg-[#ddf0fb]/40 rounded-full blur-3xl pointer-events-none -translate-y-1/2" />
      ...
      <div className="container max-w-7xl px-4 sm:px-6 md:px-8 mx-auto relative z-10">
        ...
        <div className="text-center mb-10 md:mb-14 max-w-2xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-rose-500/10 text-rose-600 text-xs font-black uppercase tracking-wider shadow-2xs">
          ...
          <p className="text-gray-500 font-medium text-sm sm:text-base md:text-lg">
            Our most popular pet foods, grooming essentials, and wellness
            products loved by thousands of happy cats.
          </p>
        </div>
