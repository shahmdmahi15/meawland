...
export function AllProductsTable({ products }: AllProductsTableProps) {
  ...
  return (
    <div className="space-y-4 w-full min-w-0 max-w-full">
      ...
      <div className="p-3 sm:p-4 rounded-xl border bg-card space-y-3 w-full min-w-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-2 pt-2 border-t text-xs min-w-0">
          {/* Category Filter */}
          <div>
                ...
                <TableRow>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center gap-2">
                      <Package className="h-10 w-10 stroke-1 text-muted-foreground/50" />
                    ...
                    >
                      ...
                      <TableCell className="p-2 text-center">
                        {product.isVariable ? (
                          ...
                          <span className="block h-4 w-4 mx-auto rounded-full bg-muted/40" />
                        )}
                      </TableCell>
                      ...
                      <TableCell className="py-3">
                        <div className="space-y-1">
                          {stock === 0 ? (
                            ...
                            <Badge
                              variant="outline"
                              className="text-[10px] py-0 border-amber-500 text-amber-600 bg-amber-50 dark:bg-amber-950/20"
                            >
                              Low: {stock} units
                            </Badge>
                          ) : (
                            <Badge
                              variant="secondary"
                              className="text-[10px] py-0 bg-emerald-500/10 text-emerald-600"
                            >
                              {stock} in stock
                            </Badge>
                          )}
